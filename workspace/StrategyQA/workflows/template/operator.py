...
from workspace.StrategyQA.workflows.template.operator_an import *
from workspace.StrategyQA.workflows.template.op_prompt import *
...
class AnswerGenerate(Operator):
    ...
    async def __call__(self, input: str, _mode: str = None) -> Tuple[str, str]:
